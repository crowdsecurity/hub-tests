...
// 	if err = retrieveAndUnmarshal(localConfig.targetDir+"/"+localConfig.PoInputFile, &poInput); err != nil {
...
// 	expectedPoResultsFile := localConfig.targetDir + "/" + localConfig.PoResultFile

// 	expected_bytes, err := ioutil.ReadFile(expectedPoResultsFile)
// 	if err != nil {
// 		log.Warningf("no results in %s, will dump data instead!", localConfig.targetDir)
...
// 		if err = marshalAndStore(bucketsInput, localConfig.targetDir+"/"+localConfig.ReprocessInputFile); err != nil {
